...
Proof. xcf. xmatch; xapp~ ;=> x L' ->; xsimpl~; fequals. Qed.
...
Proof. xcf. xmatch; xapp~ ;=> x L' ->; xsimpl~. Qed.
...
Proof. xcf. xmatch; xapp~; xsimpl~. Qed.
...
Lemma echunk_split_spec : forall (A: Type) (IA: Inhab A) (EA: Enc A) (c: echunk_ A) (L: list A) (i: int),
	...
	SPEC (echunk_split c i)
		...
		POST (fun '(c0, c1) => \exists L0 L1,
			...
			c1 ~> EChunk L1).
Proof.
	introv Hi. xcf. xchange echunk_inv_length ;=> HL.
