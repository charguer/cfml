...
Proof using.
	introv Hsz. xcf_skip_xpay*. simpl.
	xapp*. intros a L ->.
	xapp*. intros pa.
...
Lemma parray_get_spec : forall A (IA: Inhab A) (EA: Enc A) (M: Memory A) (pa: parray_ A) (L: list A) (i: int),
	...
	SPEC (parray_get pa i)
		...
		POST (fun M' x => \[x = L[i]]).
Proof using.
	introv Rpa Hind. xcf_skip_xpay*. simpl.
...
Proof using.
	introv Rpa Hi. xcf_skip_xpay*. simpl.
...
Proof using.
	introv Rpa. xcf_skip_xpay*. simpl.
