...
(*
  ...
  { applys* eval_app_arg.
    { applys eval_app_fix E. simpl. do 3 (rewrite var_eq_spec; case_if).
      { applys eval_fun. }
    { 
    { applys* eval_val. }
    { applys* eval_val. } applys* eval_like_app_fix2. }

 lets: eval_app_fix. simpl. do 2 (rewrite var_eq_spe c; case_if). applys eval_fun. }
  { applys* eval_val. }
  { applys* eval_app_fun. }

  { applys* eval_like_app_fix2 E. simpl. do 3 (rewrite var_eq_spec; case_if).
    { applys eval_fun. } { applys eval_fun. } { applys* eval_app_fun. } }
  { applys* eval_val. }
  { applys* eval_app_fun. }
Qed.
*)
...
Proof using. introv EQ1 N1 N2 N3. applys wp_eval_like. applys* eval_like_app_fix3. Qed.
...
Proof using.
  introv M1 N1 N2 N3 M2. rewrite var_eq_spec in N1,N2,N3. rew_bool_eq in *.
...
Tactic Notation "xwp" :=
  ...
  first [ applys xwp_lemma_fun; [ reflexivity | ]
        ...
        | applys xwp_lemma_fix3; [ reflexivity | reflexivity | reflexivity | reflexivity | ] ];
  xwp_simpl.
